...
export function CountdownButtonsControllers({
  hexColor
}: {
  hexColor?: string
}) {
  const { startCountdown, stopCountdown, addFiveMinutes, removeFiveMinutes } = useCountdown();
  ...
  return (
    <div className="controllers">
      ...
      <button className="controller add" onClick={addFiveMinutes}>
        <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
      ...
      <button className="controller rm" onClick={removeFiveMinutes}>
        <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
